      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          <div className="flex items-center">
            ...
            {isMobileMenuOpen && (
              <div className="absolute top-16 left-0 right-0 bg-white dark:bg-zinc-800 border-b-2 border-zinc-200 dark:border-zinc-700 shadow-lg md:hidden">
                <div className="px-4 py-4 space-y-3">
                  <Link
                    href="/post-editor"
                    onClick={() => setIsMobileMenuOpen(false)}
                    className="block px-3 py-2 rounded-lg text-sm font-medium text-zinc-700 hover:bg-zinc-100 dark:text-zinc-300 dark:hover:bg-zinc-700"
                  >
                    投稿作成
                  </Link>
                  <Link
                  ...
                  <a
                    ...
                    className="flex items-center gap-2 block px-3 py-2 rounded-lg text-sm font-medium text-indigo-700 hover:bg-indigo-100 dark:text-indigo-300 dark:hover:bg-indigo-900"
                  >
                  ...
                  <div className="border-t-2 border-zinc-200 dark:border-zinc-700 pt-3">
                    {status === 'loading' ? (
                      <div className="h-10 w-full animate-pulse rounded-full bg-zinc-200 dark:bg-zinc-700" />
                    ) : session ? (
                      <div className="space-y-3">
                        ...
                        <button
                          ...
                          className="w-full flex items-center justify-center gap-2 rounded-lg bg-zinc-100 px-3 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-200 dark:bg-zinc-700 dark:text-zinc-300 dark:hover:bg-zinc-600"
                        >
                          ログアウト
                        </button>
                      </div>
                      ...
                      <Link
                        href="/auth/signin"
                        onClick={() => setIsMobileMenuOpen(false)}
                        className="flex items-center justify-center gap-2 rounded-lg bg-black px-3 py-2 text-sm font-semibold text-white hover:bg-zinc-800 dark:bg-white dark:text-black dark:hover:bg-zinc-200"
                      >
